package kr.ac.kmu.wise.virtualcursor;
...
public class NameGenerator {
    ...
    public NameGenerator() {
       ...
       // String nameInstructions[] = {"cvdcvcv","cvdcvdcv","cvcvcv","cvcvdcv","cvcvcvd","cvdcvcvd","cvdcvd","cvdcv"};

//        String voKr[]={"a","ya","eo","yeo","o","yo","u","yu","ae","yae","i","eu","oe","e","ye","wi","wa","wae","we","wo","ui"};
//        String strConKr[]={"s","k","d","j","n","p","h","ch","r","m","p",};
//        String endConKr[]={"ng","k","n","m","l"};
        String nameInstructions[] = {"cvdcvcv","cvdcvdcv","cvcvcv","cvcvdcv","cvcvcvd","cvdcvcvd","cvdcvd","cvdcv"};



        String voKr[]={"a","i","o","u"};
        String strConKr[]={"s","k","j","p","h","ch","y","w"};
        String endConKr[]={"ng","k","n","m","l"};
        this.vocals.addAll(Arrays.asList(voKr));
        this.startConsonants.addAll(Arrays.asList(strConKr));
        this.endConsonants.addAll(Arrays.asList(endConKr));
    ...
    public static String getNamePattern(final String name){
